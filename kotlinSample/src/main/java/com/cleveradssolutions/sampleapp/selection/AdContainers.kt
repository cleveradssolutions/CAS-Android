...
import com.cleveradssolutions.sampleapp.banner.AdaptiveBannerAdActivity
import com.cleveradssolutions.sampleapp.banner.BannerAdActivity
import com.cleveradssolutions.sampleapp.banner.MediumRectangleAdActivity
...
enum class AdContainers(val titleResId: Int, val activity: KClass<*>) {
    ...
    MrecBanner(R.string.adFormats_mrecBannerAd, MediumRectangleAdActivity::class),
