...
|:----------------------:|:------------------------------:|:-------:|:------------------------------------:| :----------: |
| `:ironsource:8.11.0.0` |  Banner, Interstitial, Rewarded | Yes |   [view](IronSource/CHANGELOG.md)    | [link](https://developers.ironsrc.com/ironsource-mobile/android/sdk-change-log/) |
|   `:google:24.5.0.1`   |  Banner, Interstitial, Rewarded, AppOpen, Native | Yes | [view](GoogleMobileAds/CHANGELOG.md) | [link](https://developers.google.com/admob/android/rel-notes) |
|   `:unity:4.16.1.0`    |  Banner, Interstitial, Rewarded | Yes |    [view](UnityAds/CHANGELOG.md)     | [link](https://docs.unity.com/ads/en-us/manual/Changelog) |
| `:chartboost:9.9.3.0`  |  Banner, Interstitial, Rewarded | Yes |   [view](Chartboost/CHANGELOG.md)    | [link](https://docs.chartboost.com/en/monetization/integrate/android/changelog/) |
|   `:vungle:7.5.1.0`    |  Banner, Interstitial, Rewarded, AppOpen, Native | Yes | [view](LiftoffMonetize/CHANGELOG.md) | [link](https://support.vungle.com/hc/en-us/articles/15722228922395-Download-Vungle-SDK-for-Android-Amazon) |
...
|  `:applovin:13.3.1.2`  |  Banner, Interstitial, Rewarded, AppOpen, Native | Yes |    [view](AppLovin/CHANGELOG.md)     | [link](https://github.com/AppLovin/AppLovin-MAX-SDK-Android/releases) |
|   `:pangle:7.5.0.2`    |  Banner, Interstitial, Rewarded, AppOpen, Native | Yes |     [view](Pangle/CHANGELOG.md)      | [link](https://www.pangleglobal.com/publisher/integration) |
|    `:bigo:5.5.1.0`     |  Banner, Interstitial, Rewarded, AppOpen, Native | Yes |      [view](Bigo/CHANGELOG.md)       | [link](https://www.bigossp.com/guide/sdk/android/version) |
|  `:yandex:27.15.1.0`   |  Banner, Interstitial, Rewarded, AppOpen, Native | Yes | [view](YandexMobileAds/CHANGELOG.md) | [link](https://github.com/yandexmobile/yandex-ads-sdk-android/blob/master/changelogs/mobileads/CHANGELOG.md) |
...
| `:cas-exchange:4.3.1`  |  Banner, Interstitial, Rewarded | Yes |   [view](CASExchange/CHANGELOG.md)   | [link](null) |
...
|   `:startio:5.2.4.0`   |  Banner, Interstitial, Rewarded, AppOpen, Native | No |     [view](StartIO/CHANGELOG.md)     | [link](https://support.start.io/hc/en-us/articles/5813405015442-Android-SDK-Change-Log) |
|   `:maticoo:1.8.6.2`   |  Banner, Interstitial, Rewarded, AppOpen, Native | Yes |     [view](Maticoo/CHANGELOG.md)     | [link](https://www.yuque.com/maticoo/ivzbqi/qoothshaokc75cl7) |
...
|   `:verve:3.6.1.0`    |  Banner, Interstitial, Rewarded | Yes |      [view](Verve/CHANGELOG.md)      | [link](https://github.com/pubnative/pubnative-hybid-android-sdk/releases) |
...
```kotlin
dependencies {
    implementation("com.cleveradssolutions:<adapter name>:+")
}
```